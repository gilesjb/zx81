...
unsigned char buffer[] = {
    TOP,
    LEFT,0x00,0x86,0x00,0x87,0x01,0x00,W,0x00,0x02,0x04,0x00,0x06,0x00,
    LEFT,0x87,0x07,0x80,0x07,0x82,0x00,W,0x00,0x81,0x84,0x80,0x84,0x04,
    LEFT,0x07,0x80,0x80,0x80,0x07,0x05,W,0x85,0x84,0x80,0x80,0x80,0x84,
    LEFT,0x01,0x86,0x04,0x83,0x01,0x01,W,0x02,0x02,0x83,0x87,0x06,0x02,
...
int main() {
    ...
    for (;;) {
        ...
        *dfile = buffer + y;
        ...
        unsigned char *px = buffer + 15 + x, *pxx = px + dx;
